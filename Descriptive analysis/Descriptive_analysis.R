...
attachment_porcentaje <- datos |>
  ...
  mutate(attachment_EU = fct_relevel(attachment_EU, "Very", "Fairly", "Not very", "Not at all"))
...
ggplot(attachment_porcentaje, aes(x = attachment_EU, y = porcentaje, fill = attachment_EU)) +
  ...
  scale_fill_manual(values = c("#388E3C", "#81C784", "#E57373", "#D32F2F")) +
  labs(
